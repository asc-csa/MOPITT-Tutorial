...
# Codes pour filtrer et convertir en fichier .csv les fichier HDFEOS (.he5), et visualiser les données MOPITT pour le Space Apps Challenge Covid19 du 30-31 Mai 2020. 
...
Dernière modification le 2020-05-21

## Données MOPITT 

Les données ont été téléchargées en format HDFEOS (.he5) à partir de https://eosweb.larc.nasa.gov/project/mopitt/mop02j_v008
Il est à noter que le satellite MOPITT prend entre 3 et 4 jours pour obtenir une mesure globale des données.
 ...
 - Les niveaux 1 et 3, ainsi que NIR (Near Infrared Radiances) et TIR (Thermal Infrared Radiances) sont aussi disponibles sur https://eosweb.larc.nasa.gov/project/mopitt/mopitt_table[
Les données sont prises pour tous les jours disponibles de mars-avril 2019 et 2020.
...
Pour "MOPITTData_ReaderAndVisualization.py" : 
 ...
 - Pour visualiser les données avec le script de la NASA, il faut installer la librairie python Basemap, un module de Matplotlib qui permet de faire de la visualisation sur une carte du monde:  conda install basemap



------------------------------ ENGLISH (Français précède) ------------------------------

# Short codes to filter and convert MOPITT data from HDFEOS (.he5) to .csv, as well as visualize them for the Covid19 Space Apps Challenge of May 30-31, 2020.
...
The data was downloaded in HDFEOS format (.he5) from https://eosweb.larc.nasa.gov/project/mopitt/mop02j_v008 
It should be noted that the MOPITT satellite takes between 3 to 4 days to aquire the global data. 
 ...
 - Level 1 and 3 data, as well as NIR (Near Infrared Radiances) and TIR (Thermal Infrared Radiances) can be found at https://eosweb.larc.nasa.gov/project/mopitt/mopitt_table

The data is provided for days throughout March-April 2019 and March-April 2020. 
...
For "MOPITTData_ReaderAndVisualization.py":
 ...
 - To visualize the data, the Basemap python library is needed : conda install basemap. This Matplotlib module is used to visualize the data on a world map. 
